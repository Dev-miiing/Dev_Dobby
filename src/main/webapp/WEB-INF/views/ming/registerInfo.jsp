...
<%@ page language="java" contentType="text/html; charset=UTF-8"
         pageEncoding="UTF-8"%>
&lt;%&ndash;<% java.util.Date now = new java.util.Date();
...
&lt;%&ndash;<h1>AGRE_YN=${paramValues.AGRE_YN}</h1>
...
<h1>AGRE_YN=${paramValues.AGRE_YN[5]}</h1>&ndash;%&gt;
<h1>MBR_GRD="웰컴"</h1>
<h1>MBR_TYPE_CD="2"</h1>
<h1>MBR_STUS_CD="1"</h1>
<h1>SNS_YN="N"</h1>
